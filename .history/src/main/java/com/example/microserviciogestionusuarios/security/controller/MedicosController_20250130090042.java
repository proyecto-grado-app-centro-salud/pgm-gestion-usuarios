...
public class MedicosController {
    ...
    @PreAuthorize("hasAnyAuthority('SUPERUSUARIO','ADMINISTRADOR')")
    @PutMapping("/{id}")
    public @ResponseBody MedicoEntity actualizar(@PathVariable String id, @RequestBody MedicoEntity actualizada) {
    ...
    public @ResponseBody ApiResponse eliminarPaciente(@PathVariable String idMedico) {
