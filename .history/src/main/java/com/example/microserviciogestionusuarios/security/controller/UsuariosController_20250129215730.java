...
public class UsuariosController {
    ...
    @PostMapping("/cambiar-contrasenia-adm")
    public ResponseEntity<Void> cambiarPasswordAdministracion(@RequestBody Map<String, String> body) throws Exception {
            userService.cambiarPasswordAdm(body.get("username"), body.get("nuevoPassword"));
            return new ResponseEntity<>(HttpStatus.OK);
    ...
    public ResponseEntity<Void> deleteUsuario(@PathVariable String idUsuario) throws Exception {
